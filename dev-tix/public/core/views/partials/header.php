...
<head>
    ...
    <!-- PAGE ICON -->
    <link rel="icon" href="<?php echo SERVER_PATH; ?>/core/assets/media/images/page-icon.io">
    <!-- IMPORTED FONTS -->
    ...
    <link rel="stylesheet" href="<?php echo SERVER_PATH; ?>/core/assets/css/views/<?php echo $page; ?>.css">
    <!-- PAGE TITLE -->
